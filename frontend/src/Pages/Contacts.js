  ...
  return (
    <div className="flex flex-col items-center px-4 py-12 text-center">
      <section className="mb-12">
        ...
        <p className="text-sm">Address: 123 Main Street, Suite 100<br />Cityville, State 12345<br />Estonia</p>
      </section>
      ...
      <section className="w-full max-w-md">
        ...
        <Form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Form.Group className="mb-3 d-flex justify-content-center" controlId="formGroupCaptcha">
                <ReCAPTCHA
