    ...
    <Container className="mt-5">
      <Card className="p-4 profile-card mb-4">
        <div className="d-flex align-items-center">
          <Image src="https://avatar.iran.liara.run/public" roundedCircle className="me-3 avatar-image" width={100} />
          <div>
            <h4>{user.username}</h4>
      ...
      <Card className="p-4 profile-card mb-4">
        ...
        <Button className="btn-custom-primary" onClick={handleAddProduct}>
          Add new product
        </Button>
      </Card>
        ...
        {user.products && user.products.length > 0 ? (
          <ListGroup>
            {user.products.map((product) => (
              <ListGroup.Item key={product.id} className="d-flex align-items-center list-group-item">
                <Image
      ...
      <div className="text-center mt-4">
        <Button className="btn-custom-dark" onClick={onLogout}>
          Log out
        </Button>
      </div>
    </Container>
